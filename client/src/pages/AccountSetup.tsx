...
export default function AccountSetupPage() {
  ...
  const presetCourier = parameters.get("courier") || "";
  ...
  const effectiveBusinessNumber = staffSetup.data?.businessNumber ?? businessNumber;
